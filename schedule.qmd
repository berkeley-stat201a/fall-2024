...
| 5 | More on exchangeability and hypegeometric distribution, Boole's inequality (union bound), Cauchy-Schwarz inequality, concentration inequalities (Markov, Chevyshev); weak LLN |
| 6 | Convergence of Random Variables, strong LLN, CLT, almost sure convergence, convergence in probability, convergence in r-mean, convergence in distribution, equal in distribution vs equal in probability, examples of convergence |
